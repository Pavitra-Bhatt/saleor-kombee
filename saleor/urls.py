...
# from saleor.graphql.views import GraphQLFileUploadGraphQLView
# from .graphql.views import PatchedGraphQLView
...
urlpatterns = [
    re_path(
        r"^graphql/$",
        csrf_exempt(GraphQLView.as_view(schema=schema, backend=backend)),
        name="api",
    ),
    re_path(
