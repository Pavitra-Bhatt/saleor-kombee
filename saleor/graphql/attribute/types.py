...
from saleor.attribute.models.base import Attribute, AttributeValue
...
def get_or_create_attribute_and_value(attr_name, value, is_variant=False):
    ...
    attribute, created = Attribute.objects.get_or_create(
        ...
        defaults={
            "name": attr_name,
            "slug": attr_slug,
            "type": "PRODUCT_TYPE" if not is_variant else "VARIANT_TYPE",
            "input_type": "DROPDOWN",
    ...
    # Optionally, assign to product/variant types if needed

    # 2. Get or create the attribute value
